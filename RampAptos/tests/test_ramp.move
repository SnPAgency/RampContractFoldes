...
module RampAptos::ramp_test {
    ...
    //public entry fun test_initialize(owner: signer, admin: address, user_one: address) {
...
//
    //    let test_info = ramp::initialize_test(owner, admin, user_one);
//
    //    let (is_active, controller) = ramp::get_global_storage();
//
    //    assert!(is_active, 1);
    //    assert!(controller == @0xface, 2);
    //}
