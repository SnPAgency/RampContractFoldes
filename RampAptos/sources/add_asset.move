...
//
    //    fa_coin::mint(owner, signer::address_of(owner), 10000000000000000);
//
    //    ramp::add_asset(owner, metadata, 1u64, 10000000000000);
//
...
//
    ...
    fun onramp_deposit(owner: &signer) {
        ...
        fa_coin::mint(owner, signer::address_of(owner), 100000000000000);

        ramp::off_ramp_deposit(owner, metadata, 1000000000000, 1, 1, b"test");
